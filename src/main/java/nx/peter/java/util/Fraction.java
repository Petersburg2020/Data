...
public class Fraction {
    ...
    public Fraction set(double decimal) {
        ...
        // System.out.println("Decimal Portion: " + d);
        if (d > 0) {
    ...
    public Fraction set(double numerator, double denominator) {
        int tens = Util.digitCount(Math.max(Util.getDecimalPortion(abs(numerator)), Util.getDecimalPortion(abs(denominator))));
    ...
    public String trueValue() {
        return isInteger() ? String.valueOf(getNumerator()) : String.valueOf(getDecimal());
    }
    ...
    protected static class Mixed extends Fraction {
        ...
        @Override
        public String toString() {
            return decimal + " = " + whole + "(" + numerator + "/" + denominator + ")";
        }
    }
